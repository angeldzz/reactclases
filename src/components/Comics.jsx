...
export default class Comics extends Component {
    ...
    deleteComic = (index) => {
        // Con el metodo SPLICE indicamos el indice a eliminar y el numero de elementos de una coleccion
            ...
            <div>
                <h1>-----Comics-----</h1>
                {
                    ...
                    <div style={{backgroundColor:"fuchsia"}}>
                        ...
                        <img style={{width:"240px",height:"240px"}} src={this.state.favorito.imagen} alt="favorito"/>
